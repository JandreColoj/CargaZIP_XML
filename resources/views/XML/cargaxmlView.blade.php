...
<div class="ed-container s-100 m-85 cross-start container_dash" ng-controller="cargaxmlCtrl" ng-cloak>
   <div class="head_content">
      <h1>Carga de archivo ZIP</h1>
      <div class="cont_btns_head">
         <a ng-click="modalNuevoVendedor()" class="btn btn_opcion" >Subir</a>
      </div>
   </div>
...
@endsection
@push('scripts')
   <script src="/js/Controller/cargaxmlCtrl.js"></script>
@endpush
