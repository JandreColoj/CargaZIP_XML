{{-- Carga de  Productos --}}
<div class="caja_modal" ng-if="formulario_carga">
   <div id="modal_nuevo">
      ...
      <div class="contenido_area coloblan">
         <div class="col-sm-12 fleft_phonecp mtop">
            ...
            <div class="col-sm-12 col-xs-12 spd spi">
               <div class="ed-container">
                  ...
                  <div class="form-group btnbox_center ed-item s-100">
                     <a href="https://pagalocard.s3.amazonaws.com/pagaloPOS/PlantillaProductos.xlsx" class="link_plantilla">Descargar plantilla</a>
                  </div>
               </div>
            ...
            <div class="col-sm-12 col-xs-12 spd spi" ng-if="datosExcel.length > 0 && dataExcelValid">
               <div class="form-group btnbox_center ed-item s-100">
                  <button type="button" class="btn btn_save" ng-click="cargaProductos()"> Cargar Productos </button>
               </div>
            </div>
